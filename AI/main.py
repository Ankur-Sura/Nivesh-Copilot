...
# Why? Because other modules need environment variables
...
app = FastAPI(
    title="Nivesh Copilot AI Service",
    description="""
    This is the AI backend service for Nivesh Copilot.
    
    It provides:
    - AI Agents with web search capabilities for stock research
    - Speech-to-Text (Whisper) for voice commands
    - Stock price data via Yahoo Finance
    - Specialized Indian stock search (MoneyControl, Screener, ET)
    
    📌 This service is called by the Node.js Backend (port 3002)
    """,
    version="1.0.0"
)
"""
...
def health_check():
    ...
    Returns: {"status": "ok", "message": "Nivesh Copilot AI Service is running!"}
    ...
    return {
        "status": "ok",
        "message": "Nivesh Copilot AI Service is running!"
    }
...
def root():
    ...
    """
    return {
        "message": "Welcome to Nivesh Copilot AI Service!",
...
def main():
    ...
    """
    print("\n" + "=" * 60)
    print("🚀 Starting Nivesh Copilot AI Service...")
    print("=" * 60)
